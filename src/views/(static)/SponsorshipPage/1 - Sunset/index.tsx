    ...
    <div className='relative flex w-full flex-col items-center bg-sunset-gradient'>
        <div className='-mb-24 flex h-[45.5rem] w-fit flex-col items-center justify-center pb-20 md:h-[59.5rem] md:items-start lg:h-[52.5rem] '>
          <div className = 'flex items-end'>
            ...
            <h1 className='z-10 font-heading text-3xl uppercase md:text-4xl lg:text-[75px] text-off_white'>
              2025
            </h1>
            
          </div>
          <h1 className='z-10 font-heading text-6xl uppercase md:pl-16 md:text-8xl lg:text-[150px] text-off_white'>
            Hacks
          </h1>
