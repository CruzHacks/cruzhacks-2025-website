  ...
  return (
    <Card introTitle='Finished Your Project?' title='Submit Project'>
      <div className='m-auto flex flex-col items-center gap-5 md:w-5/6'>
        <p className='pb-10'>
          Log in to CruzHacks portal and head over to Portal&gt;Team&gt;Submit
          Project. Follow instructions accordingly to submit your project or
          click the button below to be taken directly!
        </p>
        <Button
          text='Submit Project'
          link='https://cruzhacks-2024.devpost.com/'
          type='full'
